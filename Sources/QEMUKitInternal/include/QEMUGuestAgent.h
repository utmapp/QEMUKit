...
@class QEMUGuestAgentNetworkInterface;
@class QEMUGuestAgentExecStatus;

/// For `guestFileSeek`
typedef NS_ENUM(NSInteger, QEMUGuestAgentSeek) {
    kQEMUGuestAgentSeekSet,
    kQEMUGuestAgentSeekCur,
    kQEMUGuestAgentSeekEnd,
};

/// Interface with QEMU Guest Agent
@interface QEMUGuestAgent : QEMUManager
...
@interface QEMUGuestAgentNetworkAddress : NSObject
...
@interface QEMUGuestAgentNetworkInterface : NSObject
...
@property (nonatomic) NSArray<QEMUGuestAgentNetworkAddress *> *ipAddresses;
...
@interface QEMUGuestAgentExecStatus : NSObject
